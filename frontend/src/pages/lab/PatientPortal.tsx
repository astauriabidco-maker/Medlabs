...
export default function PatientPortal() {
  ...
  const tenantSlug =
    ...
    user?.tenantName?.toLowerCase().replace(/\s+/g, "-") ||
    "demo-lab";
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">
          Portail d'accès patient sécurisé par OTP
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Affichez ce lien ou QR code dans votre salle d'attente pour
            permettre à vos patients d'accéder facilement à leurs résultats.
          </p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Logo, couleurs et branding du portail patient
              </p>
            </div>
          </div>
          <a
